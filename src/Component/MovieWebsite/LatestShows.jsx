...
export default function ShowsRecommendedForYou() {
  ...
  useEffect(() => {
    fetch(
      `https://api.themoviedb.org/3/tv/airing_today?api_key=95586a2cff275e69f05e2f2ddbee0211&page=${page}`
    )
      .then((res) => res.json())
      .then((data) => setWebSeries(data.results));
  }, [page]);
