...
const LogIn = () => {
  ...
  return (
    <div className='loginForm'>
        ...
        <div><input type="text" placeholder='Email' name="" id="" className='inputTag' onChange={(e)=>{setEmail(e.target.value)}}/></div>
        <div><input type="text" placeholder='Password' name="" id=""  className='inputTag' onChange={(e)=>{setPassword(e.target.value)}}/></div>
