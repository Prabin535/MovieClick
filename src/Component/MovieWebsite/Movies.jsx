...
const Movies = () => {
  ...
  let filteredData2 = useSelector(
    (state) => state.combineReducersdata.searcheddata
  );
  function nextPage() {
    setPage(page + 1);
  }
    ...
    <>
      {searchData?.length ? (
        <div className="movieList">
          <h3 style={{ padding: "1%" }}>Your Searched Movies</h3>
          ...
          {sessionStorage.user ? (
            <div className="movieList">
              ...
              <div className="button">
                <button onClick={nextPage} className="loadBtn">
                  Load More
                </button>
              </div>
            </div>
